...
- Labels kommen aus dem SDK-Blatt der Liste (Units, Weapon, Traps ...), nie aus der Feldanzahl — neun Blattpaare teilen sich eine Anzahl und waren bis v1.3 falsch beschriftet. Eigene Namen liegen pro Blatt in `~/tw1_par_labels_v2.json`
