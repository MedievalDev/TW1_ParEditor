...
- Labels come from the SDK sheet of the list (Units, Weapon, Traps ...), never from the field count — nine sheet pairs share a count and used to be mislabelled (fixed in v1.4). Your overrides are per sheet in `~/tw1_par_labels_v2.json`
